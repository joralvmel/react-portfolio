        ...
        <g id="SVGRepo_iconCarrier">
            <defs>
                ...
                >
                    ...
                    <stop offset="0.23" stopColor="#523"></stop>
                    <stop offset="0.36" stopColor="#534"></stop>
                    <stop offset="0.51" stopColor="#645"></stop>
                    <stop offset="0.66" stopColor="#568"></stop>
                    <stop offset="0.84" stopColor="#29d"></stop>
                </linearGradient>
                <linearGradient
                    id="b"
                    x1="29.71"
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset="0.081" stopColor="#c33"></stop>
                    <stop offset="0.189" stopColor="#de5239"></stop>
                    <stop offset="0.313" stopColor="#f06e3e"></stop>
                    <stop offset="0.421" stopColor="#fa8042"></stop>
                    <stop offset="0.5" stopColor="#fe8643"></stop>
                    <stop offset="0.58" stopColor="#fa7f42"></stop>
                    <stop offset="0.696" stopColor="#ef6c3e"></stop>
                    <stop offset="0.833" stopColor="#dc4c37"></stop>
                    <stop offset="0.916" stopColor="#cf3633"></stop>
                </linearGradient>
            </defs>
